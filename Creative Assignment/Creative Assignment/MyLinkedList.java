public class MyLinkedList<E>  {
    ...
    /**This method merges two lists. If both lists (calling list and the parameter list) are empty, then an empty
    ...
    public MyLinkedList<E> merge(MyLinkedList<E> paramList){
        MyLinkedList<E> resultList = new MyLinkedList<>();

        if (this.head == null && paramList.head == null){
            return resultList;
        }
        else if (this.head == null){
            return paramList;
        }
        else if (paramList.head == null){
            return this;
        }
        else{
            for (Node<E> ptr = this.head; ptr != null; ptr = ptr.next){
                resultList.append(ptr.element);
            }

            for (Node<E> paramPtr = paramList.head; paramPtr != null; paramPtr = paramPtr.next){
                resultList.append(paramPtr.element);
            }
